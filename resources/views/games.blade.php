...
<div  style="display: flex;">
    ...
    <div style="width: 15%; margin: 0 1vw;">
        <h2 class="categoryTitle">Juegos de Mesa</h2>
        <form method="GET" action="{{route('games')}}" id="buscador">
...
-->
    ...
    <div style="display: flex; flex-wrap:wrap; justify-content:space-around;  width: 60%; margin: 0 2vw;">
        ...
        <div style="margin: 2vw; max-width:15vw ;background: #009DE0;">
            <a href="{{Route('game.detail',['id'=>$game->id])}}"><img class="imageArt" src="{{ route('image.file', ['filename'=> $game->image]) }}" alt="Juegos" style="width:100%;"></a>
            <br>
            
            <p class="tituloArt">{{$game->name }} </p>
        </div>
